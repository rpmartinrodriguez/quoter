<template>
  ...
  <v-dialog v-model="dialogs.typeSelection" persistent max-width="450">
    <v-card class="text-center pa-4">
        ...
        <p class="body-1 text-medium-emphasis mb-6">
          La información se copió al portapapeles. ¿Cómo deseas guardar este registro?
        </p>
        
        <div class="d-flex flex-column ga-3">
          <v-btn color="success" size="large" variant="flat" @click="handleTypeSelected('VENTA')" prepend-icon="mdi-check-decagram">
            Confirmar como Venta
          </v-btn>
          <v-btn color="info" size="large" variant="tonal" @click="handleTypeSelected('COTIZACIÓN')" prepend-icon="mdi-file-document-outline">
...
<style>
/* ... (Todos tus estilos anteriores se mantienen aquí) ... */
</style>
